...
## Technical Context
- **Language/Version**: Python 3.13 (backend), HTML/JavaScript (frontend)
...
### Frontend SPA
- The frontend will be a simple SPA generated by the backend which use HTML + vanilla JS and hash-based routing.
...
- **Table name**: `AlbumsApp`
  ...
  - **Attributes**:
    - For albums: `album_id`, `name`, `description`, `created_at`, `updated_at`
